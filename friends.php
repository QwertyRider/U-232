...
/////////////////////// FRIENDS BLOCK ///////////////////////////////////////
    ...
    $res = mysql_query("SELECT f.friendid as id, u.username AS name, u.class, u.chatpost, u.leechwarn, u.username, u.avatar, u.offavatar, u.pirate, u.king, u.title, u.donor, u.warned, u.enabled, u.last_access FROM friends AS f LEFT JOIN users as u ON f.friendid = u.id WHERE userid=$userid ORDER BY name") or sqlerr(__FILE__, __LINE__);
    ...
    else
    {
      ...
      while ($friend = mysql_fetch_assoc($res))
      {
        ...
        $userlink = "<a href='userdetails.php?id={$friend['id']}'></a>";
...
//////////////////// ENEMIES BLOCK ////////////////////////////
    ...
    $res = mysql_query("SELECT b.blockid as id, u.username AS name, u.donor, u.warned, u.chatpost, u.leechwarn, u.pirate, u.king, u.username, u.enabled, u.last_access FROM blocks AS b LEFT JOIN users as u ON b.blockid = u.id WHERE userid=$userid ORDER BY name") or sqlerr(__FILE__, __LINE__);
    ...
    else
    {
      ...
      while ($block = mysql_fetch_assoc($res))
      {
        ...
        $blocks .= "<p><a href='userdetails.php?id={$block['id']}'></a>";
