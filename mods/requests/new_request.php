...
mysql_query("INSERT INTO requests (hits, userid, cat, request, descr, added) VALUES(1,$CURUSER[id], $cat, $request2, $descr, ".TIME_NOW.")") or sqlerr(__FILE__,__LINE__);
$id = mysql_insert_id();

mysql_query("INSERT INTO voted_requests VALUES(0, $id, $CURUSER[id])") or sqlerr();
