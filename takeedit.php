...
$select_torrent = @sql_query('SELECT name, descr, category, visible, poster, url, anonymous, sticky, owner, allow_comments, nuked, nukereason, filename, save_as FROM torrents WHERE id = '.sqlesc($id)) or sqlerr(__FILE__, __LINE__);
