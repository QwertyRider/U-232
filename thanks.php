...
if (!isset($CURUSER))
  ...
  function print_list() {
    ...
    $qt = mysql_query("SELECT th.userid,u.username FROM thanks as th INNER JOIN users as u ON u.id=th.userid WHERE th.torrentid={$tid} ORDER BY u.class DESC") or sqlerr();
